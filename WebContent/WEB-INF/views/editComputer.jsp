                    ...
                    <form action="EditComputer" method="POST">
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="computerName" name="computerName" value="${name}" placeholder="<c:out value="${name}"></c:out>">
                            </div>
                            <div class="form-group">
                     ...
                     <c:if test="${ !empty computerEdited }"><span id="computerEdited"><c:out
										value="${computerEdited}"></c:out> </span></c:if>
                </div>
            </div>
        </div>
    </section>
